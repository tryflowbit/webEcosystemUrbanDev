      ...
      <div className="max-w-6xl mx-auto relative z-10 space-y-16">
        ...
        <div className="text-center space-y-4 max-w-2xl mx-auto">
          ...
          <motion.h2
            ...
            className="text-3xl sm:text-4xl lg:text-5xl text-[#1C1A17] dark:text-white leading-tight tracking-[0.12em]"
          >
            <span className="font-serif italic font-light tracking-wide normal-case text-[#C5A880] block sm:inline sm:mr-4">Seleccionar</span>
            <span className="font-display uppercase font-light block sm:inline">Desarrollo</span>
          </motion.h2>
